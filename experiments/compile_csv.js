...
for (const r of results) {
  ...
  // Create relative Excel/Sheets hyperlink to make checking seamless for manual verifyers
  const hyperFormula = `=HYPERLINK("audio/${r.file_name}", "Play Audio")`;
